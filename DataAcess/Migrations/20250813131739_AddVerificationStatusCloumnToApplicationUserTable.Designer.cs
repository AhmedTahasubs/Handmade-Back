...
namespace DataAcess.Migrations
{
    ...
    [Migration("20250813131739_AddVerificationStatusCloumnToApplicationUserTable")]
    partial class AddVerificationStatusCloumnToApplicationUserTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Domain.CustomerRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.Domain.Product", b =>
                {
                    ...
                    b.Property<DateTime?>("EmbeddingsUpdatedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("TitleEmbedding")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Models.Domain.Payment", b =>
                {
                    b.HasOne("Models.Domain.CustomerOrder", "Order")
                        .WithOne("Payment")
                        .HasForeignKey("Models.Domain.Payment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Models.Domain.ApplicationUser", b =>
                {
                    b.HasOne("Models.Domain.Image", "IdCardImage")
                        .WithMany()
